<?php
  ...
  //$staff_number = $_SERVER['staff_number'];
?>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title"><?php echo $row->compt_fname;?> <?php echo $row->compt_lname;?>'s Profile</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-xl-4">
                                <div class="card-box text-center">
                                   <!-- <img src="assets/images/users/Complainant.png" class="rounded-circle avatar-lg img-thumbnail"
                                        alt="profile-image"> -->

                                    
                                    <div class="text-left mt-3">
                                        
                                        <p class="text-muted mb-2 font-13"><strong>Complainant Name :</strong> <span class="ml-2"><?php echo $row->compt_fname;?> <?php echo $row->compt_lname;?></span></p>
                                        <p class="text-muted mb-2 font-13"><strong>Mobile :</strong><span class="ml-2"><?php echo $row->compt_phone;?></span></p>
                                        <p class="text-muted mb-2 font-13"><strong>Offence :</strong> <span class="ml-2"><?php echo $row->compt_addr;?></span></p>
                                        <p class="text-muted mb-2 font-13"><strong>Date of Occurence :</strong> <span class="ml-2"><?php echo $row->date_occur;?></span></p>
                                        <p class="text-muted mb-2 font-13"><strong>victim :</strong> <span class="ml-2"><?php echo $row->victim;?> </span></p>
                                        <p class="text-muted mb-2 font-13"><strong>Details of Offence :</strong> <span class="ml-2"><?php echo $row->offence_details;?></span></p>
                                        <hr>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-borderless mb-0">
                                                    ...
                                                    <?php
                                                        ...
                                                        while($row=$res->fetch_object())
                                                            {
                                                        $mysqlDateTime = $row->suspect_daterec; //trim timestamp to date
