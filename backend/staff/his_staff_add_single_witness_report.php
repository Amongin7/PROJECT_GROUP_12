...
if (isset($_POST['add_witness_report'])) {
    ...
    if ($stmt->execute()) {
        ...
        header("Location: his_staff_add_single_witness_report.php?id=$id");
        exit();
    } else {
                  ...
                  <form method="post">
                    <div class="form-row">
                      <div class="form-group col-md-6">
                        ...
                        <input type="text"
                               readonly
                               name="wit_compt_name"
                               value="<?= htmlspecialchars($row->wit_compt_name) ?>"
                               class="form-control">
                      </div>
                      <div class="form-group col-md-6">
                        ...
                        <input type="text"
                               readonly
                               name="wit_offence_details"
                               value="<?= htmlspecialchars($row->wit_offence_details) ?>"
                               class="form-control">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text"
                             readonly
                             name="wit_sd_ref"
                             value="<?= htmlspecialchars($row->wit_sd_ref) ?>"
                             class="form-control">
                    </div>

                    <div class="form-group">
                      <label>Witness Reports</label>
                      <textarea name="wit_witness"
                                class="form-control"
                                id="editor"><?= htmlspecialchars($row->wit_witness) ?></textarea>
                    </div>

                    <div class="form-group">
                      <label>Further Comments</label>
                      <textarea name="wit_witness_reports"
                                class="form-control"
                                id="editor1"><?= htmlspecialchars($row->wit_witness_reports) ?></textarea>
                    </div>

                    <button type="submit"
                            name="add_witness_report"
