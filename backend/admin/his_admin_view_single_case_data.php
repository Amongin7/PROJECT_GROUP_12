    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <?php
                ...
                $mdr_id=$_GET['mdr_id'];
                $ret="SELECT  * FROM his__records WHERE mdr_id = ?";
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    <h2 class="mb-3">Complainant's Name : <?php echo $row->mdr_compt_name;?></h2>
                                                    <hr>
                                                    <h3 class="text-danger">Victim(s) : <?php echo $row->mdrvictim;?> </h3>
                                                    <hr>
                                                    <h3 class="text-danger ">SD Reference : <?php echo $row->mdr_sd_ref;?></h3>
                                                    <hr>
                                                    <h3 class="text-danger ">Details of Offence : <?php echo $row->mdr_offence_details;?></h3>
                                                    <hr>
