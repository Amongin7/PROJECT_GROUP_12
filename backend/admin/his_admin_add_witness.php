                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Add a  Record</li>
                                        </ol>
                                    </div>
                                            ...
                                            <div class="col-12 text-sm-center form-inline" >
                                                <div class="form-group mr-2" style="display:none">
                                                    <select id="demo-foo-filter-status" class="custom-select custom-select-sm">
                                                        ...
                                                        <option value="disciplinary">Office </option>
                                                    </select>
                                                </div>
                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="his_admin_add_single_witness.php?sd_ref=<?php echo $row->sd_ref;?>" class="badge badge-success"><i class=" fas fa-file-signature"></i> Add  Record</a></td>
                                                </tr>
                                                </tbody>
                                            <?php  $cnt = $cnt +1 ; }?>
                                            <tfoot>
