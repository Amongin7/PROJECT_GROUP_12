<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['update_doc']))
		{
            ...
            $query="UPDATE his_staff SET staff_pwd =? WHERE staff_email = ?";
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Update Staff Password Details</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input required="required"  type="email" value="<?php echo $row->email;?>" class="form-control" name="staff_email" id="inputCity">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="inputCity" class="col-form-label">Password</label>
                                                    <input required="required"  type="text" value="<?php echo $row->pwd;?>"  name="staff_pwd" class="form-control" id="inputCity">
                                                </div>
