                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Witnesses</a></li>
                                            <li class="breadcrumb-item active">Add a Witness</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="his_admin_add_single_witness.php?sd_ref=<?php echo $row->sd_ref;?>" class="badge badge-success"><i class="mdi mdi-beaker "></i> Add Witness</a></td>
                                                </tr>
                                                </tbody>
                                            <?php  $cnt = $cnt +1 ; }?>
                                            <tfoot>
