                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Cases Registered</a></li>
                                            <li class="breadcrumb-item active">View s</li>
                                        </ol>
                                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            <tr>
                                                ...
                                                <th data-hide="phone">Category of the </th>
                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $row->compt_phone;?></td>
                                                    <td><?php echo $row->victim;?></td>
                                                    <td><?php echo $row->compt_type;?></td>
                                                    
                                                    <td><a href="his_admin_view_single_case.php?compt_id=<?php echo $row->compt_id;?>&&sd_ref=<?php echo $row->sd_ref;?>" class="badge badge-success"><i class="mdi mdi-eye"></i> View</a></td>
                                                </tr>
                                                </tbody>
                                            <?php  $cnt = $cnt +1 ; }?>
                                            <tfoot>
