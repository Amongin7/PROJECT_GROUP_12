                                ...
                                <div class="card-box">
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            <tr>
                                                <th>#</th>
                                                <th data-toggle="true">Owners Name</th>
                                                <th data-hide="phone"> Owner's Number</th>
                                                <th data-hide="phone">Animal Address</th>
                                                <th data-hide="phone">Animal Condition</th>
                                                <th data-hide="phone">Animal Age</th>
                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="his_admin_view_single_staffpres.php?pres_number=<?php echo $row->pres_number;?>&&pres_id=<?php echo $row->pres_id;?>" class="badge badge-success"><i class="fas fa-eye"></i> View Prescription</a></td>
                                                </tr>
                                                </tbody>
                                            <?php  $cnt = $cnt +1 ; }?>
                                            <tfoot>
